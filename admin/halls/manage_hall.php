...
<div class="container-fluid">
    <form action="" id="hall-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter hub Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="" class="control-label">Hub Image</label>
